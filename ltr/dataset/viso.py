...
class Viso(BaseVideoDataset):
    ...
    def get_sequence_info(self, seq_id):
        ...
        class_num=seq_path.split('/')[-1]  #car028
        num = re.search(r'[0-9]+', class_num).group() #028
        classname = re.search(r'[a-z]+', class_num).group()  #car
        seq_path=os.path.join(self.root,classname,num)
